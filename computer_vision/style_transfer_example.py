...
# d2l.set_figsize()
content_img = image.imread('../d2l-zh/img/rainier.jpg')
# d2l.plt.imshow(content_img.asnumpy())

style_img = image.imread('../d2l-zh/img/autumn_oak.jpg')
...
def compute_loss(X, contents_Y_hat, styles_Y_hat, contents_Y, styles_Y_gram): # 分别计算内容损失、样式损失和总变差损失
...
output = train(content_X, contents_Y, styles_Y, ctx, 0.01, 51, 200)

nd.save('style_transfer.log', output)
print('data saved in style_transfer.log')